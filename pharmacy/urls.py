...
from pharmacy.views import signup_view, login_view, logout_view,add_pharmacy, csv_upload, search_medicine, get_pharmacy_medicines, get_user_pharmacies
...
urlpatterns = [
    ...
    path("auth/add-pharmacy/", add_pharmacy),
]